...
class Home extends PureComponent {
        ...
        if (!token) {
            this.setState({
                recentProducts: JSON.parse(
                    window.localStorage.getItem("recentProducts")
                ),
            });
            return;
        }
    ...
    renderProductName = (rp) => {
        ...
        let productVariantName = `(${
            rp.product.product_color_variant.color.name !== "no-color"
                ? rp.product.product_color_variant.color.name + " ,"
                : ""
        }${rp.product.size.name})`;
    ...
    render() {
        const { categories, bestDealProducts, recentProducts } = this.state;
        ...
        return (
            <>
                ...
                <RecentlyViewedProducts recentProducts={recentProducts} />
